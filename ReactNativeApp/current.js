...
function FeedVideoPlayer({ source = "", style = {}, id, itemId, index,
  mute, thumbnail, videoVolumme, controlFeedVolume, isVisible = false }) {
  ...
  useEffect(() => {
    setPaused(!isVisible)
    // console.log(videoPlayer.current, "curr")
  ...
  return (
    <TouchableOpacity activeOpacity={1} onPress={() => controlFeedVolume(!videoVolumme)} >
      <View style={styles.container}>
        ...
        {!fullScreen ? (
          <>
            ...
            <Video
              ref={videoPlayer}
              source={source ? { ...source, cache: true } : null}
